...
-->
	...
	<div class="container">
		<div class="row">
			<form method="post" action="act_login.jsp">
				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
					...
					<tbody>
						...
						<tr>
							<td><textarea class="form-control" placeholder="pw" id="pw" name="pw" maxlength=500></textarea></td>
						</tr>
					</tbody>
				</table>
				<div align="left">
				<a href="signup.jsp" class="btn btn-primary pull-left">회원가입</a>
				</div>
				<div  align="right">
				<!-- 취소버튼 -->
				<input type="button" class="btn btn-primary pull-right" OnClick="javascript:history.back(-1)" value="취소">
